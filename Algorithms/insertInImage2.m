function imgOut = insertInImage2(varargin)
...
for k = 1:numel(insertionCommand)
        insertionCommand2=insertionCommand{k}; PVs2=PVs{k};    
    for ii=1:numel(insertionCommand{k})
    insertObject(insertionCommand2{ii},PVs2{ii});
    end
end
