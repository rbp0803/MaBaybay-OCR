...
%named BAYBAYIN SVM-OCR SYSTEM (Baybayin_only.m) that outputs the equivalent Latin  % 
%unit of each Baybayin character                                                    % 
% ----------------------------------------------------------------------------------%
...
function P=Baybayin_only(Mdl, input,iniTime,limit)
